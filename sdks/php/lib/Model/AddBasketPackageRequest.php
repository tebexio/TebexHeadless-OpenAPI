...
class AddBasketPackageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets dynamic
     *
     * @param bool|null $dynamic Set to `true` when adding a package that belongs to a dynamic category. When omitted, the API acts as if a normal package ID was provided.
     *
     * @return self
     */
