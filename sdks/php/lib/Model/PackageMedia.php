...
/**
 * PackageMedia Class Doc Comment
 *
 * @category Class
 * @package  TebexHeadless
 * @author   OpenAPI Generator team
 ...
 */
class PackageMedia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageMedia';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name A file name for the media, if applicable.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL of the package media.
     *
     * @return self
     */
     ...
     * Sets featured
     *
     * @param bool|null $featured True if this media should be featured more prominently than others.
     *
     * @return self
     */
     ...
     * Sets primary
     *
     * @param bool|null $primary True if this is the primary media for the package.
     *
     * @return self
     */
