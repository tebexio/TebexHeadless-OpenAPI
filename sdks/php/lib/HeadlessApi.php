...
class HeadlessApi
{
    ...
    /**
     * Operation getTieredCategoriesForUser
     *
     * Gets a store&#39;s categories including all package information with them.
     *
     * @param  string $token The webstore identifier. (required)
     ...
     * @return \TebexHeadless\Model\CategoryResponse
     */
    public function getTieredCategoriesForUser($token, $username_id, string $contentType = self::contentTypes['getTieredCategoriesForUser'][0])
    {
        list($response) = $this->getTieredCategoriesForUserWithHttpInfo($token, $username_id, $contentType);
        return $response;
    }

    /**
     * Operation getTieredCategoriesForUserWithHttpInfo
     *
     * Gets a store&#39;s categories including all package information with them.
     *
     * @param  string $token The webstore identifier. (required)
     ...
     * @return array of \TebexHeadless\Model\CategoryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTieredCategoriesForUserWithHttpInfo($token, $username_id, string $contentType = self::contentTypes['getTieredCategoriesForUser'][0])
    {
        $request = $this->getTieredCategoriesForUserRequest($token, $username_id, $contentType);
    ...
    /**
     * Operation getTieredCategoriesForUserAsync
     *
     * Gets a store&#39;s categories including all package information with them.
     *
     * @param  string $token The webstore identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTieredCategoriesForUserAsync($token, $username_id, string $contentType = self::contentTypes['getTieredCategoriesForUser'][0])
    {
        return $this->getTieredCategoriesForUserAsyncWithHttpInfo($token, $username_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTieredCategoriesForUserAsyncWithHttpInfo
     *
     * Gets a store&#39;s categories including all package information with them.
     *
     * @param  string $token The webstore identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTieredCategoriesForUserAsyncWithHttpInfo($token, $username_id, string $contentType = self::contentTypes['getTieredCategoriesForUser'][0])
    {
        $returnType = '\TebexHeadless\Model\CategoryResponse';
        $request = $this->getTieredCategoriesForUserRequest($token, $username_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTieredCategoriesForUserRequest($token, $username_id, string $contentType = self::contentTypes['getTieredCategoriesForUser'][0])
    {

        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling getTieredCategoriesForUser'
            );
        }
        ...
        if ($username_id === null || (is_array($username_id) && count($username_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $username_id when calling getTieredCategoriesForUser'
            );
        }
     ...
     *
     * @param  string $token The webstore identifier. (required)
     * @param  float $tier_id The tier identifier (required)
