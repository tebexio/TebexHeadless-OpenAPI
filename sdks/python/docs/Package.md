...
**ident** | **str** | The package&#39;s string identifier. | [optional] 
**vip_status** | **str** | The package&#39;s VIP status. Only &#x60;null&#x60; has been observed so far, so the non-null type is unconfirmed. | [optional] 
