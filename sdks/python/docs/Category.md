...
**active_tier** | [**Tier**](Tier.md) | If this is a tiered category and the usernameId is provided, this will be the active tier information for this category. | [optional] 
...
**image_url** | **str** | URL of the category image, if set. | [optional] 
