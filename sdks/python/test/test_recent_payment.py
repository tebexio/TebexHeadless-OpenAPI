...
class TestRecentPayment(unittest.TestCase):
    """RecentPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecentPayment:
        """Test RecentPayment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecentPayment`
        """
        model = RecentPayment()
        if include_optional:
