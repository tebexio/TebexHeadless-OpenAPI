...
class TestApplyCouponRequest(unittest.TestCase):
    """ApplyCouponRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplyCouponRequest:
        """Test ApplyCouponRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyCouponRequest`
        """
    ...
    def testApplyCouponRequest(self):
        """Test ApplyCouponRequest"""
