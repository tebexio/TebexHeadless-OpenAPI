...
class TestServerStatusData(unittest.TestCase):
    """ServerStatusData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerStatusData:
        """Test ServerStatusData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerStatusData`
        """
