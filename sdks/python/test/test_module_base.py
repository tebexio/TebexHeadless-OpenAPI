...
class TestModuleBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModuleBase:
        """Test ModuleBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModuleBase`
        """
        model = ModuleBase()
        if include_optional:
            return ModuleBase(
                ...
                data = TebexHeadless.models.data.data()
            )
        else:
            return ModuleBase(
                id = 56,
