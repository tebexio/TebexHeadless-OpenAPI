...
class DynamicPackageInput(BaseModel):
    """
    ...
    custom: Optional[Dict[str, StrictStr]] = Field(default=None, description="Arbitrary custom key/value data to associate with the package.")
    __properties: ClassVar[List[str]] = ["name", "price", "slug", "description", "image_url", "custom"]
