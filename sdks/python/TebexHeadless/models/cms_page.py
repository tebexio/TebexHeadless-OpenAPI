...
class CMSPage(BaseModel):
    ...
    sequence: Optional[StrictBool] = None
    content: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "account_id", "title", "slug", "private", "hidden", "disabled", "sequence", "content"]
