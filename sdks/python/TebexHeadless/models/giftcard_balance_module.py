...
class GiftcardBalanceModule(BaseModel):
    """
    ...
    type: Optional[Any]
    start_time: datetime
    end_time: Optional[datetime] = Field(default=None, description="Nullable; when null the module is ongoing.")
    data: GiftcardBalanceData
    __properties: ClassVar[List[str]] = ["id", "type", "start_time", "end_time", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GiftcardBalanceData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
