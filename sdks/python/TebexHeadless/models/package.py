...
class Package(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "image", "type", "category", "base_price", "sales_tax", "total_price", "currency", "discount", "disable_quantity", "disable_gifting", "expiration_date", "created_at", "updated_at"]
