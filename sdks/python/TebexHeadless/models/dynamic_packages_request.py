...
class DynamicPackagesRequest(BaseModel):
    """
    DynamicPackagesRequest
    """ # noqa: E501
    username: StrictStr = Field(description="The username of the authenticated customer the packages are being created for.")
    category_id: StrictInt = Field(description="The ID of the dynamic category to populate.")
    packages: List[DynamicPackageInput]
    __properties: ClassVar[List[str]] = ["username", "category_id", "packages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "packages": [DynamicPackageInput.from_dict(_item) for _item in obj["packages"]] if obj.get("packages") is not None else None
        })
        return _obj
