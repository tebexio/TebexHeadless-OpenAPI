...
class Webstore(BaseModel):
    ...
    disabled: Optional[StrictBool] = Field(default=None, description="True if the store is disabled.")
    created_at: Optional[datetime] = Field(default=None, description="The date and time when the store was created")
    supports_usernames: Optional[StrictBool] = Field(default=None, description="True if the store's platform identifies customers by username.")
    supports_gifting: Optional[StrictBool] = Field(default=None, description="True if packages can be gifted to another user.")
    __properties: ClassVar[List[str]] = ["id", "description", "name", "webstore_url", "currency", "lang", "logo", "platform_type", "platform_type_id", "disabled", "created_at", "supports_usernames", "supports_gifting"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supports_usernames": obj.get("supports_usernames"),
            "supports_gifting": obj.get("supports_gifting")
        })
        return _obj
