...
class RecentPaymentsData(BaseModel):
    """
    RecentPaymentsData
    """ # noqa: E501
    header: StrictStr
    payments: List[RecentPayment]
    __properties: ClassVar[List[str]] = ["header", "payments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payments": [RecentPayment.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None
        })
        return _obj
