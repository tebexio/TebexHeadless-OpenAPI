...
class WebstoreResponse(BaseModel):
    """
    Wrapped webstore information in a \"data\" object.
    """ # noqa: E501
    data: Optional[WebstoreResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": WebstoreResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
