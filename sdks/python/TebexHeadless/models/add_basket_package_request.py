...
class AddBasketPackageRequest(BaseModel):
    """
    AddBasketPackageRequest
    """ # noqa: E501
    package_id: StrictStr
    quantity: StrictInt
    dynamic: Optional[StrictBool] = Field(default=None, description="Set to `true` when adding a package that belongs to a dynamic category. When omitted, the API acts as if a normal package ID was provided.")
    __properties: ClassVar[List[str]] = ["package_id", "quantity", "dynamic"]
