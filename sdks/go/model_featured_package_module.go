...
// checks if the FeaturedPackageModule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeaturedPackageModule{}

// FeaturedPackageModule struct for FeaturedPackageModule
type FeaturedPackageModule struct {
	Id int64 `json:"id"`
	Type interface{} `json:"type"`
	StartTime time.Time `json:"start_time"`
	// Nullable; when null the module is ongoing.
	EndTime *time.Time `json:"end_time,omitempty"`
	Data FeaturedPackageData `json:"data"`
}

type _FeaturedPackageModule FeaturedPackageModule
...
func (o FeaturedPackageModule) MarshalJSON() ([]byte, error) {
...
func (o FeaturedPackageModule) ToMap() (map[string]interface{}, error) {
...
func (o *FeaturedPackageModule) UnmarshalJSON(data []byte) (err error) {
	...
	varFeaturedPackageModule := _FeaturedPackageModule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFeaturedPackageModule)

	if err != nil {
		return err
	}

	*o = FeaturedPackageModule(varFeaturedPackageModule)

	return err
}

type NullableFeaturedPackageModule struct {
	value *FeaturedPackageModule
	isSet bool
}

func (v NullableFeaturedPackageModule) Get() *FeaturedPackageModule {
	return v.value
}

func (v *NullableFeaturedPackageModule) Set(val *FeaturedPackageModule) {
	v.value = val
	v.isSet = true
}

func (v NullableFeaturedPackageModule) IsSet() bool {
	return v.isSet
}

func (v *NullableFeaturedPackageModule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeaturedPackageModule(val *FeaturedPackageModule) *NullableFeaturedPackageModule {
	return &NullableFeaturedPackageModule{value: val, isSet: true}
}

func (v NullableFeaturedPackageModule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeaturedPackageModule) UnmarshalJSON(src []byte) error {
	v.isSet = true
