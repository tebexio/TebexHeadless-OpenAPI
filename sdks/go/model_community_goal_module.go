...
// checks if the CommunityGoalModule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommunityGoalModule{}

// CommunityGoalModule struct for CommunityGoalModule
type CommunityGoalModule struct {
	Id int64 `json:"id"`
	Type interface{} `json:"type"`
	StartTime time.Time `json:"start_time"`
	// Nullable; when null the module is ongoing.
	EndTime *time.Time `json:"end_time,omitempty"`
	Data CommunityGoalData `json:"data"`
}

type _CommunityGoalModule CommunityGoalModule
...
func (o CommunityGoalModule) MarshalJSON() ([]byte, error) {
...
func (o CommunityGoalModule) ToMap() (map[string]interface{}, error) {
...
func (o *CommunityGoalModule) UnmarshalJSON(data []byte) (err error) {
	...
	varCommunityGoalModule := _CommunityGoalModule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommunityGoalModule)

	if err != nil {
		return err
	}

	*o = CommunityGoalModule(varCommunityGoalModule)

	return err
}

type NullableCommunityGoalModule struct {
	value *CommunityGoalModule
	isSet bool
}

func (v NullableCommunityGoalModule) Get() *CommunityGoalModule {
	return v.value
}

func (v *NullableCommunityGoalModule) Set(val *CommunityGoalModule) {
	v.value = val
	v.isSet = true
}

func (v NullableCommunityGoalModule) IsSet() bool {
	return v.isSet
}

func (v *NullableCommunityGoalModule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommunityGoalModule(val *CommunityGoalModule) *NullableCommunityGoalModule {
	return &NullableCommunityGoalModule{value: val, isSet: true}
}

func (v NullableCommunityGoalModule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommunityGoalModule) UnmarshalJSON(src []byte) error {
	v.isSet = true
