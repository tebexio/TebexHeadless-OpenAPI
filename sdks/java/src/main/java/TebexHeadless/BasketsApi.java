...
public class BasketsApi {
     ...
     */
    public BasketResponse addBasketPackage(String basketIdent, AddBasketPackageRequest addBasketPackageRequest) throws ApiException {
     ...
     */
    public ApiResponse<BasketResponse> addBasketPackageWithHttpInfo(String basketIdent, AddBasketPackageRequest addBasketPackageRequest) throws ApiException {
     ...
     */
    public okhttp3.Call addBasketPackageAsync(String basketIdent, AddBasketPackageRequest addBasketPackageRequest, final ApiCallback<BasketResponse> _callback) throws ApiException {
     ...
     */
    public BasketResponse removeBasketPackage(String basketIdent, RemoveBasketPackageRequest removeBasketPackageRequest) throws ApiException {
     ...
     */
    public ApiResponse<BasketResponse> removeBasketPackageWithHttpInfo(String basketIdent, RemoveBasketPackageRequest removeBasketPackageRequest) throws ApiException {
     ...
     */
    public okhttp3.Call removeBasketPackageAsync(String basketIdent, RemoveBasketPackageRequest removeBasketPackageRequest, final ApiCallback<BasketResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updatePackageQuantityCall(String basketIdent, String packageId, UpdatePackageQuantityRequest updatePackageQuantityRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] { "https://headless.tebex.io/api/baskets" };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePackageQuantityValidateBeforeCall(String basketIdent, String packageId, UpdatePackageQuantityRequest updatePackageQuantityRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'basketIdent' is set
        if (basketIdent == null) {
     ...
     */
    public void updatePackageQuantity(String basketIdent, String packageId, UpdatePackageQuantityRequest updatePackageQuantityRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> updatePackageQuantityWithHttpInfo(String basketIdent, String packageId, UpdatePackageQuantityRequest updatePackageQuantityRequest) throws ApiException {
     ...
     */
    public okhttp3.Call updatePackageQuantityAsync(String basketIdent, String packageId, UpdatePackageQuantityRequest updatePackageQuantityRequest, final ApiCallback<Void> _callback) throws ApiException {
