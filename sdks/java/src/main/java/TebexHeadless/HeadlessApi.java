...
public class HeadlessApi {
     ...
     */
    public List<BasketAuthResponseInner> getBasketAuthUrl(String token, String basketIdent, String returnUrl) throws ApiException {
        ApiResponse<List<BasketAuthResponseInner>> localVarResp = getBasketAuthUrlWithHttpInfo(token, basketIdent, returnUrl);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<BasketAuthResponseInner>> getBasketAuthUrlWithHttpInfo(String token, String basketIdent, String returnUrl) throws ApiException {
    ...
    /**
     * Get authentication links for a basket. (asynchronously)
     * Fetches a basket&#39;s auth URL.
     * @param token The webstore identifier. (required)
     * @param basketIdent The basket identifier. (required)
     * @param returnUrl The URL you would like to redirect the user to after successful basket authentication. (required)
     ...
     */
    public okhttp3.Call getBasketAuthUrlAsync(String token, String basketIdent, String returnUrl, final ApiCallback<List<BasketAuthResponseInner>> _callback) throws ApiException {
    ...
    /**
     * Build call for getTieredCategoriesForUser
     * @param token The webstore identifier. (required)
    ...
    private okhttp3.Call getTieredCategoriesForUserValidateBeforeCall(String token, Integer usernameId, final ApiCallback _callback) throws ApiException {
        ...
        if (usernameId == null) {
            throw new ApiException("Missing the required parameter 'usernameId' when calling getTieredCategoriesForUser(Async)");
        }

        return getTieredCategoriesForUserCall(token, usernameId, _callback);
    ...
    /**
     * Updates the given teir to the provided package. (asynchronously)
     * Updates a tier to a new package.
     * @param token The webstore identifier. (required)
     * @param tierId The tier identifier (required)
     * @param updateTierRequest  (optional)
