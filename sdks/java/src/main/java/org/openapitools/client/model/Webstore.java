...
public class Webstore {
  ...
  public static final String SERIALIZED_NAME_SUPPORTS_USERNAMES = "supports_usernames";
  @SerializedName(SERIALIZED_NAME_SUPPORTS_USERNAMES)
  private Boolean supportsUsernames;

  public static final String SERIALIZED_NAME_SUPPORTS_GIFTING = "supports_gifting";
  @SerializedName(SERIALIZED_NAME_SUPPORTS_GIFTING)
  private Boolean supportsGifting;
  ...
  **/
  ...
  public Webstore disabled(Boolean disabled) {
  ...
  **/
  ...
  public Webstore supportsUsernames(Boolean supportsUsernames) {
    this.supportsUsernames = supportsUsernames;
    return this;
  }

   /**
   * True if the store&#39;s platform identifies customers by username.
   * @return supportsUsernames
  **/
  @javax.annotation.Nullable
  public Boolean getSupportsUsernames() {
    return supportsUsernames;
  }

  public void setSupportsUsernames(Boolean supportsUsernames) {
    this.supportsUsernames = supportsUsernames;
  }


  public Webstore supportsGifting(Boolean supportsGifting) {
    this.supportsGifting = supportsGifting;
    return this;
  }

   /**
   * True if packages can be gifted to another user.
   * @return supportsGifting
  **/
  @javax.annotation.Nullable
  public Boolean getSupportsGifting() {
    return supportsGifting;
  }

  public void setSupportsGifting(Boolean supportsGifting) {
    this.supportsGifting = supportsGifting;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webstore.id) &&
        ...
        Objects.equals(this.supportsUsernames, webstore.supportsUsernames) &&
        Objects.equals(this.supportsGifting, webstore.supportsGifting);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, name, webstoreUrl, currency, lang, logo, platformType, platformTypeId, disabled, createdAt, supportsUsernames, supportsGifting);
  }
  ...
  public String toString() {
    ...
    sb.append("    supportsUsernames: ").append(toIndentedString(supportsUsernames)).append("\n");
    sb.append("    supportsGifting: ").append(toIndentedString(supportsGifting)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("supports_usernames");
    openapiFields.add("supports_gifting");
