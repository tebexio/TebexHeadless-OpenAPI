...
public class ModelPackage {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, image, type, category, basePrice, salesTax, totalPrice, currency, proratePrice, discount, disableQuantity, disableGifting, expirationDate, createdAt, updatedAt);
  }
