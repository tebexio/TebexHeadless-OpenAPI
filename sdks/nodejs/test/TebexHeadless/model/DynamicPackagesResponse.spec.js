...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.DynamicPackagesResponse();
  });
  ...
  describe('DynamicPackagesResponse', function() {
    it('should create an instance of DynamicPackagesResponse', function() {
      // uncomment below and update the code to test DynamicPackagesResponse
      //var instance = new TebexHeadlessApi.DynamicPackagesResponse();
      //expect(instance).to.be.a(TebexHeadlessApi.DynamicPackagesResponse);
    });
