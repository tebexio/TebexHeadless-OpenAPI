...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.PaymentGoalData();
  });
  ...
  describe('PaymentGoalData', function() {
    it('should create an instance of PaymentGoalData', function() {
      // uncomment below and update the code to test PaymentGoalData
      //var instance = new TebexHeadlessApi.PaymentGoalData();
      //expect(instance).to.be.a(TebexHeadlessApi.PaymentGoalData);
    });
