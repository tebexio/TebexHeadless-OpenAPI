...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.RecentPayment();
  });
  ...
  describe('RecentPayment', function() {
    it('should create an instance of RecentPayment', function() {
      // uncomment below and update the code to test RecentPayment
      //var instance = new TebexHeadlessApi.RecentPayment();
      //expect(instance).to.be.a(TebexHeadlessApi.RecentPayment);
    });
