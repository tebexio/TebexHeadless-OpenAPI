...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.RemoveGiftCardRequest();
  });
  ...
  describe('RemoveGiftCardRequest', function() {
    it('should create an instance of RemoveGiftCardRequest', function() {
      // uncomment below and update the code to test RemoveGiftCardRequest
      //var instance = new TebexHeadlessApi.RemoveGiftCardRequest();
      //expect(instance).to.be.a(TebexHeadlessApi.RemoveGiftCardRequest);
    });
