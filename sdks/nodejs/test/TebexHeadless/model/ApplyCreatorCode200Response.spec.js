...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.ApplyCreatorCode200Response();
  });
  ...
  describe('ApplyCreatorCode200Response', function() {
    it('should create an instance of ApplyCreatorCode200Response', function() {
      // uncomment below and update the code to test ApplyCreatorCode200Response
      //var instance = new TebexHeadlessApi.ApplyCreatorCode200Response();
      //expect(instance).to.be.a(TebexHeadlessApi.ApplyCreatorCode200Response);
    });
