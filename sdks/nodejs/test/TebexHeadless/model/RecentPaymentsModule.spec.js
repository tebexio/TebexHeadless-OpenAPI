...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.RecentPaymentsModule();
  });
  ...
  describe('RecentPaymentsModule', function() {
    it('should create an instance of RecentPaymentsModule', function() {
      // uncomment below and update the code to test RecentPaymentsModule
      //var instance = new TebexHeadlessApi.RecentPaymentsModule();
      //expect(instance).to.be.a(TebexHeadlessApi.RecentPaymentsModule);
    });
