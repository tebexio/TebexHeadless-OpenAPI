...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.Tier();
  });
  ...
  describe('Tier', function() {
    it('should create an instance of Tier', function() {
      ...
      //var instance = new TebexHeadlessApi.Tier();
      //expect(instance).to.be.a(TebexHeadlessApi.Tier);
    });
    ...
    it('should have the property pendingDowngradePackage (base name: "pending_downgrade_package")', function() {
      // uncomment below and update the code to test the property pendingDowngradePackage
      //var instance = new TebexHeadlessApi.Tier();
      //expect(instance).to.be();
    });
