...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.GiftcardBalanceModule();
  });
  ...
  describe('GiftcardBalanceModule', function() {
    it('should create an instance of GiftcardBalanceModule', function() {
      // uncomment below and update the code to test GiftcardBalanceModule
      //var instance = new TebexHeadlessApi.GiftcardBalanceModule();
      //expect(instance).to.be.a(TebexHeadlessApi.GiftcardBalanceModule);
    });
