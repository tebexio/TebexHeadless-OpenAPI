...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.TopCustomerModule();
  });
  ...
  describe('TopCustomerModule', function() {
    it('should create an instance of TopCustomerModule', function() {
      // uncomment below and update the code to test TopCustomerModule
      //var instance = new TebexHeadlessApi.TopCustomerModule();
      //expect(instance).to.be.a(TebexHeadlessApi.TopCustomerModule);
    });
