...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.SinglePackageResponse();
  });
  ...
  describe('SinglePackageResponse', function() {
    it('should create an instance of SinglePackageResponse', function() {
      // uncomment below and update the code to test SinglePackageResponse
      //var instance = new TebexHeadlessApi.SinglePackageResponse();
      //expect(instance).to.be.a(TebexHeadlessApi.SinglePackageResponse);
    });
