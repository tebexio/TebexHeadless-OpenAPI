...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.PaymentGoalModule();
  });
  ...
  describe('PaymentGoalModule', function() {
    it('should create an instance of PaymentGoalModule', function() {
      // uncomment below and update the code to test PaymentGoalModule
      //var instance = new TebexHeadlessApi.PaymentGoalModule();
      //expect(instance).to.be.a(TebexHeadlessApi.PaymentGoalModule);
    });
