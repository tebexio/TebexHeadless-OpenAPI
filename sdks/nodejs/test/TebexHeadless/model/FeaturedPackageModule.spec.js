...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.FeaturedPackageModule();
  });
  ...
  describe('FeaturedPackageModule', function() {
    it('should create an instance of FeaturedPackageModule', function() {
      // uncomment below and update the code to test FeaturedPackageModule
      //var instance = new TebexHeadlessApi.FeaturedPackageModule();
      //expect(instance).to.be.a(TebexHeadlessApi.FeaturedPackageModule);
    });
