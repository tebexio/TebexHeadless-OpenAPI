...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.DynamicPackagesRequest();
  });
  ...
  describe('DynamicPackagesRequest', function() {
    it('should create an instance of DynamicPackagesRequest', function() {
      // uncomment below and update the code to test DynamicPackagesRequest
      //var instance = new TebexHeadlessApi.DynamicPackagesRequest();
      //expect(instance).to.be.a(TebexHeadlessApi.DynamicPackagesRequest);
    });
