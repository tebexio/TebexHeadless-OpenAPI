...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.FeaturedPackageData();
  });
  ...
  describe('FeaturedPackageData', function() {
    it('should create an instance of FeaturedPackageData', function() {
      // uncomment below and update the code to test FeaturedPackageData
      //var instance = new TebexHeadlessApi.FeaturedPackageData();
      //expect(instance).to.be.a(TebexHeadlessApi.FeaturedPackageData);
    });
