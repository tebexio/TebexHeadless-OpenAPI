...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.Players();
  });
  ...
  describe('Players', function() {
    it('should create an instance of Players', function() {
      // uncomment below and update the code to test Players
      //var instance = new TebexHeadlessApi.Players();
      //expect(instance).to.be.a(TebexHeadlessApi.Players);
    });
