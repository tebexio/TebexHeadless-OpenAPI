...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.CommunityGoalModule();
  });
  ...
  describe('CommunityGoalModule', function() {
    it('should create an instance of CommunityGoalModule', function() {
      // uncomment below and update the code to test CommunityGoalModule
      //var instance = new TebexHeadlessApi.CommunityGoalModule();
      //expect(instance).to.be.a(TebexHeadlessApi.CommunityGoalModule);
    });
