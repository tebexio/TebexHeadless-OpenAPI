...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.TextboxData();
  });
  ...
  describe('TextboxData', function() {
    it('should create an instance of TextboxData', function() {
      // uncomment below and update the code to test TextboxData
      //var instance = new TebexHeadlessApi.TextboxData();
      //expect(instance).to.be.a(TebexHeadlessApi.TextboxData);
    });
