...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.RecentPaymentPackage();
  });
  ...
  describe('RecentPaymentPackage', function() {
    it('should create an instance of RecentPaymentPackage', function() {
      // uncomment below and update the code to test RecentPaymentPackage
      //var instance = new TebexHeadlessApi.RecentPaymentPackage();
      //expect(instance).to.be.a(TebexHeadlessApi.RecentPaymentPackage);
    });
