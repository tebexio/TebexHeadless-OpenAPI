...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.RecentPaymentsData();
  });
  ...
  describe('RecentPaymentsData', function() {
    it('should create an instance of RecentPaymentsData', function() {
      // uncomment below and update the code to test RecentPaymentsData
      //var instance = new TebexHeadlessApi.RecentPaymentsData();
      //expect(instance).to.be.a(TebexHeadlessApi.RecentPaymentsData);
    });
