...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.ModulesResponse();
  });
  ...
  describe('ModulesResponse', function() {
    it('should create an instance of ModulesResponse', function() {
      // uncomment below and update the code to test ModulesResponse
      //var instance = new TebexHeadlessApi.ModulesResponse();
      //expect(instance).to.be.a(TebexHeadlessApi.ModulesResponse);
    });
