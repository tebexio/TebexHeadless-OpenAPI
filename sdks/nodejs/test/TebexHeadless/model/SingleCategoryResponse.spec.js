...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.SingleCategoryResponse();
  });
  ...
  describe('SingleCategoryResponse', function() {
    it('should create an instance of SingleCategoryResponse', function() {
      // uncomment below and update the code to test SingleCategoryResponse
      //var instance = new TebexHeadlessApi.SingleCategoryResponse();
      //expect(instance).to.be.a(TebexHeadlessApi.SingleCategoryResponse);
    });
