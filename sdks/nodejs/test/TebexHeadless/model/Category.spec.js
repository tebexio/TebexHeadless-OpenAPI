...
(function(root, factory) {
  ...
  describe('Category', function() {
    ...
    it('should have the property tiered (base name: "tiered")', function() {
      // uncomment below and update the code to test the property tiered
      //var instance = new TebexHeadlessApi.Category();
      //expect(instance).to.be();
    });

    it('should have the property activeTier (base name: "active_tier")', function() {
      // uncomment below and update the code to test the property activeTier
      //var instance = new TebexHeadlessApi.Category();
      //expect(instance).to.be();
    });
