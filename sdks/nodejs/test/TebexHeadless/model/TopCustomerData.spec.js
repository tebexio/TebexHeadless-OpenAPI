...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.TopCustomerData();
  });
  ...
  describe('TopCustomerData', function() {
    it('should create an instance of TopCustomerData', function() {
      // uncomment below and update the code to test TopCustomerData
      //var instance = new TebexHeadlessApi.TopCustomerData();
      //expect(instance).to.be.a(TebexHeadlessApi.TopCustomerData);
    });
