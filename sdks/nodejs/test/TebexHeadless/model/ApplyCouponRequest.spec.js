...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.ApplyCouponRequest();
  });
  ...
  describe('ApplyCouponRequest', function() {
    it('should create an instance of ApplyCouponRequest', function() {
      // uncomment below and update the code to test ApplyCouponRequest
      //var instance = new TebexHeadlessApi.ApplyCouponRequest();
      //expect(instance).to.be.a(TebexHeadlessApi.ApplyCouponRequest);
    });
