...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.TextboxModule();
  });
  ...
  describe('TextboxModule', function() {
    it('should create an instance of TextboxModule', function() {
      // uncomment below and update the code to test TextboxModule
      //var instance = new TebexHeadlessApi.TextboxModule();
      //expect(instance).to.be.a(TebexHeadlessApi.TextboxModule);
    });
