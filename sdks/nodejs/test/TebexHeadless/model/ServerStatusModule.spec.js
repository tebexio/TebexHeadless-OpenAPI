...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.ServerStatusModule();
  });
  ...
  describe('ServerStatusModule', function() {
    it('should create an instance of ServerStatusModule', function() {
      // uncomment below and update the code to test ServerStatusModule
      //var instance = new TebexHeadlessApi.ServerStatusModule();
      //expect(instance).to.be.a(TebexHeadlessApi.ServerStatusModule);
    });
