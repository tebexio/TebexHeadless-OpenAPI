...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TebexHeadlessApi.ModuleBase();
  });
  ...
  describe('ModuleBase', function() {
    it('should create an instance of ModuleBase', function() {
      // uncomment below and update the code to test ModuleBase
      //var instance = new TebexHeadlessApi.ModuleBase();
      //expect(instance).to.be.a(TebexHeadlessApi.ModuleBase);
    });
