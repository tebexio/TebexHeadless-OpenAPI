...
(function(root, factory) {
  ...
  describe('HeadlessApi', function() {
    ...
    describe('getTieredCategoriesForUser', function() {
      it('should call getTieredCategoriesForUser successfully', function(done) {
        //uncomment below and update the code to test getTieredCategoriesForUser
        //instance.getTieredCategoriesForUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
