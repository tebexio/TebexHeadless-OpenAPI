...
export default class HeadlessApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getTieredCategoriesForUser operation.
     * @callback module:TebexHeadless/TebexHeadless/HeadlessApi~getTieredCategoriesForUserCallback
     * @param {String} error Error message, if any.
     * @param {module:TebexHeadless/model/CategoryResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:TebexHeadless/TebexHeadless/HeadlessApi~getTieredCategoriesForUserCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:TebexHeadless/model/CategoryResponse}
     */
    getTieredCategoriesForUser(token, usernameId, callback) {
      let postBody = null;
      // verify the required parameter 'token' is set
      if (token === undefined || token === null) {
        throw new Error("Missing the required parameter 'token' when calling getTieredCategoriesForUser");
      }
      // verify the required parameter 'usernameId' is set
      if (usernameId === undefined || usernameId === null) {
        throw new Error("Missing the required parameter 'usernameId' when calling getTieredCategoriesForUser");
      }
