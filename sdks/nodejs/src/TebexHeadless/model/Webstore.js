...
class Webstore {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('supports_usernames')) {
                obj['supports_usernames'] = ApiClient.convertToType(data['supports_usernames'], 'Boolean');
            }
            if (data.hasOwnProperty('supports_gifting')) {
                obj['supports_gifting'] = ApiClient.convertToType(data['supports_gifting'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
Webstore.prototype['disabled'] = undefined;
 ...
 * @member {Boolean} supports_usernames
 */
Webstore.prototype['supports_usernames'] = undefined;

/**
 * True if packages can be gifted to another user.
 * @member {Boolean} supports_gifting
 */
Webstore.prototype['supports_gifting'] = undefined;
