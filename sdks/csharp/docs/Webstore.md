...
**SupportsUsernames** | **bool** | True if the store&#39;s platform identifies customers by username. | [optional] 
**SupportsGifting** | **bool** | True if packages can be gifted to another user. | [optional] 
