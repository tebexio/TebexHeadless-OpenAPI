...
namespace TebexHeadless.TebexHeadless
{
    ...
    public interface IHeadlessApiSync : IApiAccessor
    {
        ...
        List<BasketAuthResponseInner> GetBasketAuthUrl(string token, string basketIdent, string returnUrl, int operationIndex = 0);
        ...
        ApiResponse<List<BasketAuthResponseInner>> GetBasketAuthUrlWithHttpInfo(string token, string basketIdent, string returnUrl, int operationIndex = 0);
        /// <summary>
    ...
    public interface IHeadlessApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<BasketAuthResponseInner>> GetBasketAuthUrlAsync(string token, string basketIdent, string returnUrl, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<BasketAuthResponseInner>>> GetBasketAuthUrlWithHttpInfoAsync(string token, string basketIdent, string returnUrl, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Fetch a basket from a webstore by its identifier
        /// </summary>
        /// <remarks>
    ...
    public partial class HeadlessApi : IHeadlessApi
    {
        ...
        /// <summary>
        /// Get authentication links for a basket. Fetches a basket&#39;s auth URL.
        /// </summary>
        /// <exception cref="TebexHeadless.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="token">The webstore identifier.</param>
        /// <param name="basketIdent">The basket identifier.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;BasketAuthResponseInner&gt;</returns>
        public List<BasketAuthResponseInner> GetBasketAuthUrl(string token, string basketIdent, string returnUrl, int operationIndex = 0)
        {
            TebexHeadless.Client.ApiResponse<List<BasketAuthResponseInner>> localVarResponse = GetBasketAuthUrlWithHttpInfo(token, basketIdent, returnUrl);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;BasketAuthResponseInner&gt;</returns>
        public TebexHeadless.Client.ApiResponse<List<BasketAuthResponseInner>> GetBasketAuthUrlWithHttpInfo(string token, string basketIdent, string returnUrl, int operationIndex = 0)
        {
            // verify the required parameter 'token' is set
            if (token == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<BasketAuthResponseInner>>("/accounts/{token}/baskets/{basketIdent}/auth?returnUrl={returnUrl}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;BasketAuthResponseInner&gt;</returns>
        public async System.Threading.Tasks.Task<List<BasketAuthResponseInner>> GetBasketAuthUrlAsync(string token, string basketIdent, string returnUrl, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TebexHeadless.Client.ApiResponse<List<BasketAuthResponseInner>> localVarResponse = await GetBasketAuthUrlWithHttpInfoAsync(token, basketIdent, returnUrl, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;BasketAuthResponseInner&gt;)</returns>
        public async System.Threading.Tasks.Task<TebexHeadless.Client.ApiResponse<List<BasketAuthResponseInner>>> GetBasketAuthUrlWithHttpInfoAsync(string token, string basketIdent, string returnUrl, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'token' is set
            if (token == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<BasketAuthResponseInner>>("/accounts/{token}/baskets/{basketIdent}/auth?returnUrl={returnUrl}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Gets a store&#39;s categories including all package information with them. Gets all categories from the webstore, returning active tier information for the given player.
        /// </summary>
        /// <exception cref="TebexHeadless.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="token">The webstore identifier.</param>
        /// <param name="usernameId"></param>
        ...
        public TebexHeadless.Client.ApiResponse<CategoryResponse> GetTieredCategoriesForUserWithHttpInfo(string token, decimal usernameId, int operationIndex = 0)
        {
            ...
            if (token == null)
            {
                throw new TebexHeadless.Client.ApiException(400, "Missing required parameter 'token' when calling HeadlessApi->GetTieredCategoriesForUser");
            }
        ...
        /// <summary>
        /// Updates the given teir to the provided package. Updates a tier to a new package.
        /// </summary>
        /// <exception cref="TebexHeadless.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="token">The webstore identifier.</param>
        /// <param name="tierId">The tier identifier</param>
