...
namespace TebexHeadless.Model
{
    ...
    public partial class Webstore : IValidatableObject
    {
        ...
        /// <param name="disabled">True if the store is disabled..</param>
        /// <param name="createdAt">The date and time when the store was created.</param>
        /// <param name="supportsUsernames">True if the store&#39;s platform identifies customers by username..</param>
        /// <param name="supportsGifting">True if packages can be gifted to another user..</param>
        public Webstore(int id = default(int), string description = default(string), string name = default(string), string webstoreUrl = default(string), string currency = default(string), string lang = default(string), string logo = default(string), string platformType = default(string), string platformTypeId = default(string), bool disabled = default(bool), DateTime createdAt = default(DateTime), bool supportsUsernames = default(bool), bool supportsGifting = default(bool))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>True if the store is disabled.</value>
        ...
        /// <example>2023-05-25T09:49:37+00:00</example>
        ...
        /// </summary>
        /// <value>True if the store&#39;s platform identifies customers by username.</value>
        /// <example>true</example>
        [DataMember(Name = "supports_usernames", EmitDefaultValue = true)]
        public bool SupportsUsernames { get; set; }

        /// <summary>
        /// True if packages can be gifted to another user.
        /// </summary>
        /// <value>True if packages can be gifted to another user.</value>
        /// <example>false</example>
        [DataMember(Name = "supports_gifting", EmitDefaultValue = true)]
        public bool SupportsGifting { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SupportsUsernames: ").Append(SupportsUsernames).Append("\n");
            sb.Append("  SupportsGifting: ").Append(SupportsGifting).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
