...
namespace TebexHeadless.Model
{
    ...
    public partial class ErrorResponse : IValidatableObject
    {
        ...
        /// <param name="status">The HTTP status code gen by the origin server for the occurrence of the problem..</param>
        ...
        /// </summary>
        /// <value>The HTTP status code gen by the origin server for the occurrence of the problem.</value>
        /// <example>400</example>
