...
namespace TebexHeadless.Model
{
    ...
    /// ApplyCouponRequest
    /// </summary>
    [DataContract(Name = "ApplyCouponRequest")]
    public partial class ApplyCouponRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplyCouponRequest" /> class.
        /// </summary>
        /// <param name="couponCode">couponCode.</param>
        public ApplyCouponRequest(string couponCode = default(string))
        {
