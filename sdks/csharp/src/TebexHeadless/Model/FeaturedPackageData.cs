...
namespace TebexHeadless.Model
{
    ...
    /// FeaturedPackageData
    /// </summary>
    [DataContract(Name = "FeaturedPackageData")]
    public partial class FeaturedPackageData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeaturedPackageData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeaturedPackageData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeaturedPackageData" /> class.
        /// </summary>
        /// <param name="header">header (required).</param>
        /// <param name="package">package (required).</param>
        public FeaturedPackageData(string header = default(string), Package package = default(Package))
        {
            // to ensure "header" is required (not null)
            if (header == null)
            {
                throw new ArgumentNullException("header is a required property for FeaturedPackageData and cannot be null");
            }
            this.Header = header;
            // to ensure "package" is required (not null)
            if (package == null)
            {
                throw new ArgumentNullException("package is a required property for FeaturedPackageData and cannot be null");
            }
        ...
        /// Gets or Sets Header
        /// </summary>
        /// <example>Featured Package</example>
