...
namespace TebexHeadless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SingleCategoryResponse")]
    public partial class SingleCategoryResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleCategoryResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public SingleCategoryResponse(Category data = default(Category))
        {
            this.Data = data;
        }
