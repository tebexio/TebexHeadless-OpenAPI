...
namespace TebexHeadless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SinglePackageResponse")]
    public partial class SinglePackageResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SinglePackageResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public SinglePackageResponse(Package data = default(Package))
        {
            this.Data = data;
        }
